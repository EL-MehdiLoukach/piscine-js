        ...
        if (i==0){
            ...
            inputRange.addEventListener("input",()=>{
                ...
                for(let i=0;i<a.length;i++){
                    a[i].setAttribute("style","width:" +inputRange.value.toString()+"px")
                }    
            })
            ...
            inputRange.addEventListener("input",()=>{
                ...
                for(let i=0;i<a.length;i++){
                    a[i].setAttribute("style","font-size:" +inputRange.value.toString()+"px")
                }    
            })
        }else if (i==2){
            ...
            inputRange.addEventListener("input",()=>{
                ...
                for(let i=0;i<a.length;i++){
                    a[i].setAttribute("style","background:" + "hsl(280,50%,"+inputRange.value.toString()+"%)")
                }    
            })
        }
